...
# MODEL=centerpoint
# RESULTS_DIR=results/nuscenes/${MODEL}02/20epochs/3xb4/nd_pillar_10s
# # CONFIG_FILE=configs/centerpoint_nuscenes/hv/centerpoint_pillar02_nd_second_secfpn_8xb4_cyclic-20e_nus-3d.py
